...
module OnboardDataUploadx
  class EngineConfigsController < ApplicationController
    ...
    def create
      ...
      @engine_config.argument_value = @engine_config.argument_value.strip if @engine_config.argument_value
    ...
    def update
      ...
      params[:engine_config][:argument_value] = params[:engine_config][:argument_value].strip if params[:engine_config][:argument_value]
